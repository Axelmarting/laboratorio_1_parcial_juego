...
class Perdida:
    ...
    foto_boton_reintentar = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\botonReintentar.png")
    rectangulo_reintentar = foto_boton_reintentar.get_rect(topleft=posicion_reintentar)

    def dibujar(self, pantalla):
        if self.visible:
            foto_pausa = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\menu_perdida.png")
