...
class Menu:
    ...
    foto_boton_jugar = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\botonJugar.png")
    rectangulo_jugar = foto_boton_jugar.get_rect(topleft=posicion_jugar)
    foto_boton_scores = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\botonScores.png")
    rectangulo_scores = foto_boton_scores.get_rect(topleft=posicion_scores)
    foto_boton_nombre = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\botonNombre.png")
    rectangulo_nombre = foto_boton_nombre.get_rect(topleft=posicion_nombre)

    def dibujar(self, pantalla):
        if self.visible:
            foto_menu = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\menu_principal.png")
