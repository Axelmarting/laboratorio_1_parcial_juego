...
class Scores:
    ...
    foto_boton_finalizar = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\botonFinalizar.png")
    ...
    def dibujar(self,pantalla,lista_ordenada, font_input):
        if self.visible:
            foto = pygame.image.load(r"C:\Users\Axel\Desktop\Programacion_1\segundo_parcial\ordenado\fotos\menu_scores.png")
